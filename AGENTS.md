...
This project is indexed by GitNexus as **Client** (681 symbols, 1180 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
