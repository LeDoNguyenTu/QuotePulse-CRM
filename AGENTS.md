...
This project is indexed by GitNexus as **Client** (1757 symbols, 3323 relationships, 145 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
