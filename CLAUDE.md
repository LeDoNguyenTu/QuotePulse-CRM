...
This project is indexed by GitNexus as **Client** (2395 symbols, 4502 relationships, 187 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
