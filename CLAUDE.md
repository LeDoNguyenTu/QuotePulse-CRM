...
This project is indexed by GitNexus as **Client** (1309 symbols, 2390 relationships, 83 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
