...
This project is indexed by GitNexus as **Client** (2048 symbols, 3846 relationships, 166 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
